...
/* Burbujas flotantes en el principal */
const bubbleContainer = document.getElementById('principalBubbles');

for (let i = 0; i < 16; i++) {
  const bubble = document.createElement('div');
  bubble.className = 'principal__bubble';
...
/* Menú hamburguesa para la version de Celuu */
